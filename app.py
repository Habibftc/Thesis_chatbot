...
# Page Config
st.set_page_config(page_title="LARGE MODEL DRIVEN DIGITAL HUMAN Q&A SYSTEM", page_icon="🤖", layout="wide")

# Custom CSS
st.markdown("""
    <style>
        .user { background-color: #2563EB; padding: 10px; border-radius: 10px; }
        .bot { background-color: #374151; padding: 10px; border-radius: 10px; }
...
# Sidebar Navigation
with st.sidebar:
    st.markdown('<h2 class="sidebar-title">🔍 LM DRIVEN DIGITAL HUMAN Q&A SYSTEM</h2>', unsafe_allow_html=True)
...
# Main Content Area
st.markdown("<h1 style='text-align: center;'>🤖 LARGE MODEL DRIVEN DIGITAL HUMAN Q&A SYSTEM</h1>", unsafe_allow_html=True)
